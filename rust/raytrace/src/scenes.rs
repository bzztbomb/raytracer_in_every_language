...
pub fn simple_scene(nx: u32, ny: u32) -> (HitablePtr, Camera, bool) {
    ...
    let objs: Vec<HitablePtr> = vec![
        ...
        Sphere::hitable_ptr(Vec3::new(1.0, 0.0, -1.0), 0.5, Metal::rc(ConstantTexture::rc(Vec3::new(0.8, 0.6, 0.2)), 0.3)),
        // Sphere::hitable_ptr(Vec3::new(-1.0, 0.0, -1.0), 0.5, Metal::rc(Vec3::new(0.8, 0.8, 0.8), 1.0)),
